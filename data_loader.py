...
class Generator(object):
    ...
    def __init__(self):
        ...
        with open("/Users/minootaghavi/Desktop/Github-minootaghavi91/Lane Detection/PINet_new/TuSimple/dataset/five.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/Users/minootaghavi/Desktop/Github-minootaghavi91/Lane Detection/PINet_new/TuSimple/dataset/four.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/Users/minootaghavi/Desktop/Github-minootaghavi91/Lane Detection/PINet_new/TuSimple/dataset/three.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
        ...
        with open("/Users/minootaghavi/Desktop/Github-minootaghavi91/Lane Detection/PINet_new/TuSimple/dataset/two.json") as f:
            while True:
                line = f.readline()
                if not line:
                    break
